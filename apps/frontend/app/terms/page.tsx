                ...
                <div className="space-y-12">
                    <section className="space-y-4">
                        ...
                        <p className="text-text-secondary leading-relaxed">
                            By accessing and using DevLens, you accept and agree to be bound by the terms and provision of this agreement. In addition, when using this Website's particular services, you shall be subject to any posted guidelines or rules applicable to such services.
                        </p>
                    </section>
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-text-secondary leading-relaxed">
                            You agree specifically not to use DevLens to:
                        </p>
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-text-secondary leading-relaxed">
                            All content included on this site, such as text, graphics, logos, button icons, images, is the property of DevLens or its content suppliers and protected by international copyright laws.
                        </p>
                    </section>
