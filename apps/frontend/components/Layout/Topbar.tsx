        ...
        <div className="flex w-full flex-nowrap items-center gap-2 md:gap-3 py-3">
          ...
          {user && user.orgIds && user.orgIds.length > 0 && (
            <div className="relative ml-2" ref={orgDropdownRef}>
              ...
              {orgDropdownOpen && (
                <div className="absolute left-0 mt-2 w-64 origin-top-left rounded-xl border border-border bg-white dark:bg-slate-900/95 backdrop-blur-3xl p-2 shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none z-[100]">
          ...
          <div className="ml-auto hidden items-center gap-3 md:flex">
            ...
            <div className="relative hidden md:block" ref={teamDropdownRef}>
              ...
              {teamDropdownOpen && (
                <div className="absolute right-0 mt-2 w-80 rounded-xl border border-border bg-white dark:bg-slate-900/95 backdrop-blur-3xl shadow-lg z-[100]">
