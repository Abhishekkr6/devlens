    ...
    <header className="sticky top-0 z-40 mb-24 border-b border-border bg-background/80 backdrop-blur-xl">
        ...
        <div className="flex w-full flex-wrap items-center gap-3 py-3">
          ...
          {user && user.orgIds && user.orgIds.length > 0 && (
            <div className="relative ml-2" ref={orgDropdownRef}>
              ...
              {orgDropdownOpen && (
                <div className="absolute left-0 mt-2 w-64 origin-top-left rounded-xl border border-border bg-background/80 backdrop-blur-xl p-2 shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none z-50">
          ...
          <div className="ml-auto hidden items-center gap-3 md:flex">
            ...
            <div className="relative hidden md:block" ref={teamDropdownRef}>
              ...
              {teamDropdownOpen && (
                <div className="absolute right-0 mt-2 w-80 rounded-xl border border-border bg-background/80 backdrop-blur-xl shadow-lg z-50">
      ...
      <div className="absolute top-16 left-0 right-0 pointer-events-none">
        <div className="mx-auto flex w-full max-w-7xl items-center justify-center px-2 py-2 sm:px-4 lg:px-8 pointer-events-auto">
          <FloatingDock
            items={dockItems}
            desktopClassName="bg-background/80 backdrop-blur-xl px-4 py-2 shadow-lg rounded-2xl border border-gray-200 dark:border-slate-700"
