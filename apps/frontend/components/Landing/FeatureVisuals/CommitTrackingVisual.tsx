...
export function CommitTrackingVisual() {
    ...
    return (
        <div className="w-full h-full font-sans bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden flex flex-col">
            {/* Header with Pulse */}
            <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-sm font-bold text-slate-900">Real-time Tracking</h3>
                </div>
                ...
                <div className="divide-y divide-slate-50">
                    {commits.map((commit, i) => (
                        <motion.div
                            ...
                            className="px-6 py-4 flex items-start gap-3 hover:bg-slate-50 transition-colors"
                        >
                            <img
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-2 mt-0.5">
                                    ...
                                    <p className="text-xs text-slate-400">{commit.time}</p>
                                </div>
                            </div>
                        </motion.div>
                    ))}
